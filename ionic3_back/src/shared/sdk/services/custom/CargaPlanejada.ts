...
import { CARGAPLANEJADA } from '../../../../dados/cargaPlanejada';
//import { of } from 'rxjs';
//Versao Ionic
 ...
 */
@Injectable()
export class CargaPlanejadaApi extends BaseLoopBackApi {
  ...
  obtemPrimeiro(filter: LoopBackFilter = {}, customHeaders?: Function) : Observable<CargaPlanejada> {
    return of(CARGAPLANEJADA[0]);
  }
